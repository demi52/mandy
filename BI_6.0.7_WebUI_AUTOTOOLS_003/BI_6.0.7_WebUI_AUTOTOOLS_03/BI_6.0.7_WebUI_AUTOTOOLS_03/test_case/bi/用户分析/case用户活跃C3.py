...
from flow.biportal.userbase import User用户活跃C3, User用户活跃详情C3
...
Test1=type("Test用户活跃C3_首页", (CaseSample首页,), {"obj": User用户活跃C3})

# Test2 = type("Test用户活跃详情C3_日",(CaseSample详情,), {"obj": User用户活跃详情C3, "time_type":"day"})

for c in Get.out(file, "tabletype"):
    exec("""
class Test用户活跃详情C3_{0}(CaseSample详情):
