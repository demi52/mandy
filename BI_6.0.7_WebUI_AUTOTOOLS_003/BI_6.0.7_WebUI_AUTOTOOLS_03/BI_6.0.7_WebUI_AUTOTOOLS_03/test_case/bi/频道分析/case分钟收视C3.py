...
from flow.biportal.channelbase import Channel分钟收视C3, Channel分钟收视详情C3
...
Test1 = type("Test分钟收视C3_首页", (CaseSample首页,), {"obj": Channel分钟收视C3})


for c in Get.out(file, "tabletype"):
    exec("""
class Test分钟收视详情C3_{0}(CaseSample详情):
