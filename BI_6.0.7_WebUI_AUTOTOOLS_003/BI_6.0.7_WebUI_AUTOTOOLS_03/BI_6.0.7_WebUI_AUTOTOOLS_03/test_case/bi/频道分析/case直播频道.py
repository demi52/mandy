...
from flow.biportal.channelbase import Channel直播频道, Channel直播频道详情
...
Test1=type("Test直播频道_首页", (CaseSample首页,), {"obj":Channel直播频道})


for c in Get.out(file, ("tabletype", "channel")):
    exec("""
class Test直播频道详情_{0}_{2}(CaseSample详情):
